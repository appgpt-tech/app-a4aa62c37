...
import { BloodTestResultsEntity } from './db/BloodTestResults.entity';
import { AppointmentsEntity } from './db/Appointments.entity';
import { MedicationsEntity } from './db/Medications.entity';
import { BloodDonationsEntity } from './db/BloodDonations.entity';
import { EducationalResourcesEntity } from './db/EducationalResources.entity';
import { CommunityForumsEntity } from './db/CommunityForums.entity';
import { EmergencyContactsEntity } from './db/EmergencyContacts.entity';
...
export class Database {
  ...
  static async Initialize(dbConfiguration: DBConfiguration) {
    ...
    dbConfig.entities = [
      SettingsEntity,
      UsersEntity,
      BloodTestResultsEntity,
      AppointmentsEntity,
      MedicationsEntity,
      BloodDonationsEntity,
      EducationalResourcesEntity,
      CommunityForumsEntity,
  ...
  static async Seed() {
    ...
    if (true) {
      ...
      await this.SeedResource('BloodTestResultsEntity', data.BloodTestResults);
      await this.SeedResource('AppointmentsEntity', data.Appointments);
      await this.SeedResource('MedicationsEntity', data.Medications);
      await this.SeedResource('BloodDonationsEntity', data.BloodDonations);
      await this.SeedResource(
        'EducationalResourcesEntity',
        data.EducationalResources,
      );
      await this.SeedResource('CommunityForumsEntity', data.CommunityForums);
      await this.SeedResource(
        'EmergencyContactsEntity',
