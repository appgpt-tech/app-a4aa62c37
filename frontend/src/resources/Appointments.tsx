...
const AppointmentsTitle = () => {
  ...
  return (
    <span>
      Appointments {record ? `"${record.appointmentDateAndTime}"` : ''}
    </span>
  );
};
...
export const AppointmentsList = () => (
  <List actions={<ListActions />} filters={ResourceFilters}>
    <DatagridConfigurable>
      ...
      <TextField source="healthcareProviderName" />
      <DateField source="appointmentDateAndTime" />
  ...
  <Edit title={<AppointmentsTitle />}>
    <SimpleForm>
      <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 5 }}>
        ...
        <Grid item xs={4}>
          <TextInput source="healthcareProviderName" />
        </Grid>
        <Grid item xs={4}>
          <DateInput source="appointmentDateAndTime" />
        </Grid>
        <Grid item xs={4}>
